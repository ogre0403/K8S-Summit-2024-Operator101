...
// OperatorV1Client is used to interact with features provided by the operator.k8s-summit.org group.
type OperatorV1Client struct {
	restClient rest.Interface
}

func (c *OperatorV1Client) MyWebs(namespace string) MyWebInterface {
	return newMyWebs(c, namespace)
}
